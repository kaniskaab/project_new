  ...
  return (
    <div>
      <div>
        ...
        <div className="ml-[400px] mt-[200px] flex flex-col ">
          <div></div>
          <div className="-mb-[80px] w-[626px] mx-auto rounded-[77px] z-10 py-3 bg-white flex items-center justify-center">
            <text className="text-[20px] font-bold font-ubu flex">
              Upcoming Consultations
            </text>
          </div>

          <div className=" w-[90%] mx-auto bg-[#c5d5e8] pt-[110px] rounded-[91px] flex flex-col items-center mb-10 pb-10">
            {consultations.map((e) => (
              <>
                {new Date(e.dateOfAppointment) > new Date() && (
                  <ul className="flex flex-col border rounded-[10px] shadow-xl w-4/5 p-3 mb-3 text-[15px] font-ubu bg-white">
                    <text className="font-bold text-[15px]">
                      {" "}
                      {e.familyMember ? (
                        <>CONSULTATION FOR {e.familyMember.name}</>
                      ) : (
                        <>CONSULTATION FOR SELF</>
                      )}
                    </text>
                    <li>
                      Date <text>{e.dateOfAppointment.slice(0, 10)}</text>{" "}
                    </li>
                    <li>
                      Time <text>{e.dateOfAppointment.slice(11, 16)}</text>{" "}
                    </li>
                    ...
                    {showQr && e.id === viewId && (
                      <div className="w-[450px] fixed bg-[#C5D5E8] shadow-2xl  flex flex-col justify-center items-center rounded-lg p-5 top-[100px] border-5 z-20">
                        <div className="bg-white flex flex-col justify-center items-center rounded-lg p-1 border-5 z-20 font-ubu text-[20px] font-bold">
                          <text>
                            Consultation with Dr. {doctorView.user.name}
                          </text>{" "}
                          <text>
                          ...
                          />{" "}
                          <h1 className="text-[15px] text-blue-500">
                            Link: {link}
                          </h1>
                          <button
                            className="bg-gray-200 rounded-full rotate-90 p-2 font-bold mt-1 hover:bg-gray-300 hover:scale-105 transition-all delay-100"
                    ...
                    {viewpres && viewpresId == e.id && (
                      <div className="fixed bg-white h-1/2 w-1/2 top-[100px] border rounded-lg p-1 border-5 z-20 font-ubu text-[20px] font-bold overflow-y-scroll">
                              ...
                              <li>
                                ...
                                {prescription.drugDetails.map((drug) => (
                                  <ul className="flex flex-col">
                                    ...
                                    <li>
                                      First time or refill:{" "}
                                      {drug.firstTimeOrRefill}
                                    </li>
                                    <li>
                                      Substitution: {drug.substitutionAllowed}
                                    </li>
                                  </ul>
                                ))}
                              </li>
                    ...
                    <button
                      onClick={() => getQr(e.id, e.doctor.id)}
                      className=" w-4/5 h-10 rounded-full flex bg-gray-200 items-center justify-center hover:bg-gray-300 hover:scale-105 transition-all delay-100 mx-auto"
                    >
                      <Eye />
                      <span className="ml-2">Show QR and Link</span>
                    </button>
                    <button
                      onClick={() => viewPres(e.id)}
                      className=" w-4/5 h-10 rounded-full flex bg-gray-200 items-center justify-center hover:bg-gray-300 hover:scale-105 transition-all delay-100 mx-auto mt-2"
                    >
                      <Eye />
                      <span className="ml-2">View Prescription</span>
                    </button>
                  </ul>
                )}
              </>
          ...
          <div className="py-4 w-[626px] mx-auto rounded-[77px] z-10 bg-white flex items-center justify-center mt-10">
            <text className="text-[20px] font-bold font-ubu flex">
              Past Consultations
            </text>
          </div>

          <div className=" w-[90%] mx-auto bg-[#c5d5e8] -mt-[100px] pt-[110px] rounded-[91px] flex flex-col items-center mb-10 pb-10">
            {consultations.map((e) => (
              <>
                {new Date(e.dateOfAppointment) < new Date() && (
                  <ul className="flex flex-col border rounded-[10px] shadow-xl w-4/5 p-3 mb-3 text-[15px] font-ubu bg-white">
                    ...
                    <li>
                      Time <text>{e.dateOfAppointment.slice(11, 19)}</text>{" "}
                    </li>
                    ...
                    <button
                      onClick={() => viewPres(e.id)}
                      className=" w-4/5 h-10 rounded-full flex bg-gray-200 items-center justify-center mt-2 hover:bg-gray-300 hover:scale-105 transition-all delay-100 mx-auto"
                    >
                      <Eye />
                      <span className="ml-2">View Prescription</span>
                    </button>
